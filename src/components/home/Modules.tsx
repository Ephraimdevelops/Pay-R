...
export function Modules() {
    return (
        <div className="bg-background space-y-24 py-20" id="modules">
            {/* Module 1: Employee Management */}
            <ModuleSection
                label="Core HR"
                title="Employee Management"
                description="Manage your entire team from a single dashboard. Add, edit, search, and access employee information effortlessly."
                features={[
                ...
                imagePosition="right"
            >
                {/* Original Card Content - No wrapper padding */}
                <div className="w-full h-full bg-card/50 backdrop-blur-xl border border-white/10 rounded-3xl p-8 relative overflow-hidden group hover:border-[#41A1E1]/30 transition-colors duration-500">
                    <div className="absolute bottom-0 right-0 w-64 h-64 bg-[#41A1E1]/10 rounded-full blur-[80px] -mr-32 -mb-32 pointer-events-none" />

                    <div className="flex items-center gap-4 mb-8">
                        <div className="w-12 h-12 rounded-2xl bg-[#41A1E1]/10 flex items-center justify-center text-[#41A1E1]">
            ...
            <ModuleSection
                ...
                description="Generate payrolls in a few clicks. The system automatically calculates salaries, allowances, deductions, and applicable taxes."
                features={[
                ...
                imagePosition="left"
            >
                <div className="w-full h-full bg-card/50 backdrop-blur-xl border border-white/10 rounded-3xl p-8 relative overflow-hidden group hover:border-emerald-500/30 transition-colors duration-500">
            ...
            <ModuleSection
                label="Hiring"
                title="Recruitment"
                description="Receive job applications directly through your company website and manage them with powerful tools for screening and shortlisting."
                features={[
                ...
                imagePosition="right"
            >
                <div className="w-full h-full bg-card/50 backdrop-blur-xl border border-white/10 rounded-3xl p-8 relative overflow-hidden group hover:border-purple-500/30 transition-colors duration-500">
            ...
            <ModuleSection
                ...
                description="Set goals, track progress, and evaluate performance consistently across your organization."
                features={[
                    "Goal Setting (OKRs)",
                    "360° Feedback",
                    "Performance Reviews",
                ...
                imagePosition="left"
            >
                <div className="w-full h-full bg-card/50 backdrop-blur-xl border border-white/10 rounded-3xl p-8 relative overflow-hidden group hover:border-orange-500/30 transition-colors duration-500">
